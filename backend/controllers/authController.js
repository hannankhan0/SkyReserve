...
const { generateUserToken, generateAdminToken } = require("../utils/tokenGenerator");
...
const register = async (req, res) => {
    try {
        if (req.body.password && !req.body.password_hash) req.body.password_hash = req.body.password;
        // Validate input
