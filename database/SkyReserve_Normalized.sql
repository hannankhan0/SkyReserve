...
-- =====================================================================
-- NORMALIZATION VERSION: 3NF-compliant schema
-- Changes from original:
--   1. Extracted Cities into a dedicated Cities table (1NF/2NF)
--   2. Extracted Seat_Class_Prices into a dedicated table (2NF/3NF)
--      removing the transitive dependency: seat_class -> price_multiplier
--   3. Removed derived/redundant column available_seats from
--      Flight_Schedules (computed from Seats table instead) (3NF)
--   4. Extracted Payment_Methods into a lookup table (1NF)
--   5. Added CHECK constraints on Bookings.total_amount referencing
--      the normalized price lookup rather than hard-coded multipliers
-- =====================================================================
